...
// Palette "Neo-Pop"
val NeoCream = Color(0xFFFFF8E7)      // Background Utama (Hangat)
val NeoPurple = Color(0xFF8E44AD)     // Primary / Brand Color
val NeoYellow = Color(0xFFFFD600)     // Accent / Tombol Action
...
val KubikSurface = Color.White
val KubikAccent = NeoPurple
val KubikWhite = NeoCream